...
import { emptyMeasurements, initializeScanner, scanMeasurements } from "@/lib/pose-estimator";
...
export default function Home() {
  ...
  useEffect(() => {
    initializeScanner().catch(() => {
      setMessage("Scanner could not initialize. Please refresh and try again.");
    });
  }, []);
